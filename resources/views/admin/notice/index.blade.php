                          ...
                          <th>内容</th>
                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/notice/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/notice',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加公告</h4>
          <div class="custom-modal-text text-left">
              <form class="form-horizontal" role="form" action="{{url('zadmin/notice')}}" method="post" enctype="multipart/form-data">                                    
