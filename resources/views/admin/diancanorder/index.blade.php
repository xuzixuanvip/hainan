                        	...
                        	<div class="col-lg-12">
                                ...
                                <div class="col-sm-10">
                                  <form role="form" id="srcForm">
                                          <div class="form-group contact-search col-sm-3">
                                            <input type="text" name="keyword" class="form-control" placeholder="手机号或姓名" value="{{array_get($param,'keyword')}}">
                                              
                                          </div>
                                           <div class="form-group col-sm-3">
                                             <input type="text" name="total_price" class="form-control" placeholder="订单金额大于等于" value="{{array_get($param,'total_price')}}">
                                           </div>
                                           <div class="form-group col-sm-3">
                                             <input type="text" name="product_num" class="form-control" placeholder="单品数量大于等于" value="{{array_get($param,'product_num')}}">
                                           </div>
          ...
          <div class="alert alert-warning">
            ...
            <strong>订单总额：</strong>{{$total->sum('total_price')}}
                          ...
                          <th>详情</th>
                                        ...
                                        <td>{{object_get($v,'user.position')}}</td>            
                                                    <td>{{$v->total_price}}</td>
                                                    <td>{{$v->created_at}}</td>
                                                    <td>
...
<script type="text/javascript">
    ...
    $('#exportBtn').on('click',function(){
      var url = "{{url('zadmin/diancan/order-export')}}";
      $('#srcForm').attr('action',url).submit();
    })

    $('#srcBtn').on('click',function(){
      var url = "{{url('zadmin/diancan/orders')}}";
      $('#srcForm').attr('action',url).submit();
    })
  </script>
    @endsection       
