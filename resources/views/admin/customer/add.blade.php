...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('zadmin/customer')}}">症状信息</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h2 class="m-t-0 header-title">新添症状</h2>
                <hr/>
                @if(session('rs'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="{{url('zadmin/customer/')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="source_code" required="" value="{{old('source_code')}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-md-3 control-label">配件单位</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="unit" required="" value="{{old('unit')}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-md-3 control-label">库存数量</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="store_num" required="" value="{{old('store_num')?old('store_num'):0}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-md-3 control-label">零售价</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="out_price"  value="{{old('out_price')}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="col-md-3 control-label">进货价</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="in_price" required="" value="{{old('in_price')}}">
                                </div>
                            </div>
