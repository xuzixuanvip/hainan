    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="{{route('tags.image_update',$data->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="status">
                                        <option value="1" {{ $data->status == 1 ? 'selected' : '' }}>激活</option>
                                        <option value="0" {{ $data->status != 1 ? 'selected' : '' }}>暂停</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <label >
                                    <img src="{{url('/').$data->image}}" alt="" style="width:150px">
