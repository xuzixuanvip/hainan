                          ...
                          <th>费用</th> -->
                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/worktype/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/worktype',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加工种</h4>
          <div class="custom-modal-text text-left">
              <form class="form-horizontal" role="form" action="{{url('zadmin/worktype')}}" method="post" enctype="multipart/form-data">                                    
