                          ...
                          <th>价格</th>
                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/services/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/services',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加维修内容</h4>
