                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                   ...
                                                   <td>{{$v->code}}</td> 
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/roles/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/roles',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加角色</h4>
          <div class="custom-modal-text text-left">
              <form class="form-horizontal" role="form" action="{{url('zadmin/roles')}}" method="post" enctype="multipart/form-data">                                    
