...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="{{url('zadmin/purchases')}}">采购单管理</a></li>
                        ...
                        <div class="row">
                        	<div class="col-lg-12">
  <form class="form-horizontal" role="form" action="{{url('zadmin/purchases')}}" method="post" >                          
          <div class="card-box">
                            <h2 class="m-t-0 header-title ">采购单基本信息</h2>
                            <hr/>
                             @if(session('rs'))
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" name="code" required="" value="{{'CG'.date('YmdHis')}}">
                      </div>
                  </div> 
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                      <label class="col-md-3 control-label">采购人</label>
                      <div class="col-md-9">
                        <input type="text" class="form-control" name="caigouer" required="" value="">
                      </div>
                  </div>

                   <div class="form-group col-md-4">
                      <label class="col-md-4 control-label">采购日期</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="bill_date" required="" value="{{date('Y-m-d')}}">
                      </div>
                  </div>
