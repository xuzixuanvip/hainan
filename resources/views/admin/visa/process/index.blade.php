                          ...
                          <th>费用</th> -->
                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/visa/process/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/visa/process',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加流程</h4>
          <div class="custom-modal-text text-left">
              <form class="form-horizontal" role="form" action="{{url('zadmin/visa/process')}}" method="post" enctype="multipart/form-data">                                    
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-10">
                                                      <input type="text" class="form-control" name="weight" value="{{$weight+1}}" required="">
                                                  </div>
                                              </div>
