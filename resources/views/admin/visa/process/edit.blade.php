...
@section('content')
                        ...
                        <div class="row">
                        	<div class="col-lg-12">
                        		<div class="card-box">
                            <h2 class="m-t-0 header-title">修改流程</h2>
                            <hr/>
                             @if(session('rs'))
                              ...
                              @endif
                        			<div class="row">
			                        	<div class="col-md-6">
                                  <form class="form-horizontal" role="form" action="{{url('zadmin/visa/process/'.$data->id)}}" method="post">{{ method_field('PUT') }}
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-10">
                                                      <input type="text" class="form-control" name="weight" required="" value="{{$data->weight}}">
                                                  </div>
                                              </div>
