                          ...
                          <th>服务时间</th>
                                            ...
                                            @foreach($list as $v)
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a href="{{url('zadmin/worklog/'.$v->id.'/edit')}}" ><i class="md md-edit"></i>编辑</a>
                                                    	<a href="{{url('zadmin/worklog',$v->id)}}" data-method="delete" 
...
@endsection
    ...
    @section('modal')        
      ...
      <div id="custom-modal" class="modal-demo">
          ...
          <h4 class="custom-modal-title">添加服务日志</h4>
