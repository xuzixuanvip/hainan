...
//===========智能导诊-身体管理=============
        ...
        Route::delete('body/delete','BodyController@delete')->name('body.delete');
        Route::delete('body/deleteAll','BodyController@deleteAll')->name('body.deleteAll');
        Route::get('body/add_symptom/{body}','BodyController@add_symptom')->name('body.add_symptom');
        Route::post('body/add_symptom/store','BodyController@symptom_store')->name('body.add_symptom.store');
// ========================================
...
//=======智能导诊---科室控制====================================
        Route::resource('department','DepartmentController',['only'=>['index','create','store','edit','update']]);
        Route::resource('tags','TagsController');
        Route::delete('department/delete','DepartmentController@delete')->name('department.delete');
        Route::get('tags/image_edit/{id}','TagsController@image_edit')->name('tags.image_edit');
        Route::post('tags/image_update/{id}','TagsController@image_update')->name('tags.image_update');
...
Route::get('daozhen','Dz\DzController@index')->name('daozhen.index');
Route::post('api/daozhen/tags','Dz\ApiDzController@tags')->name('api.tags');
Route::post('api/daozhen/symptom','Dz\ApiDzController@symptom')->name('api.symptom');
Route::post('api/daozhen/search','Dz\ApiDzController@search')->name('api.search');
Route::post('api/daozhen/bodysearch','Dz\ApiDzController@bodySearch')->name('api.bodysearch');
Route::post('api/daozhen/bodytab','Dz\ApiDzController@bodyTab')->name('api.bodyTab');
Route::get('daozhen/body','Dz\DzController@body')->name('daozhen.body');
Route::get('daozhen/body/list','Dz\DzController@bodyList')->name('daozhen.body.list');
Route::get('daozhen/symptom','Dz\DzController@symptom')->name('daozhen.symptom');
Route::post('api/symptom/search','Dz\ApiDzController@symptomSearch')->name('api.symptomSearch');
Route::post('api/symptom/search2','Dz\ApiDzController@symptomSearch2')->name('api.symptomSearch2');
Route::post('api/symptom/fenxi','Dz\ApiDzController@fenxi')->name('api.fenxi');
